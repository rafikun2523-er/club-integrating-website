# 📝 TODO List for Unified Club Portal

## 🔹 Project Setup

* [x] Organize project folders (HTML, CSS, JS, Backend)
* [x] Initialize Node.js project
* [x] Install required packages ( Mongoose)
* [x] Connect MongoDB database
* [ ] Create basic server using Node.js + Express

---

## 🔹 Frontend Development

* [x] Complete remaining HTML pages
...
* [x] Display all clubs with details
* [ ] Show club members list
* [x] Show club activities
* [x] Show club event history
